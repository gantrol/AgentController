...
internal static class MicroEnglishTranslations
{
    ...
    [
        ...
        ("已打开 Micro Bridge 插件自己的语音设置。\n{result.Message}", "Opened the Micro Bridge plugin's own voice settings.\n{result.Message}"),
        ("Micro Bridge 插件语音设置未能打开。\n{result.Message}", "The Micro Bridge plugin voice settings could not be opened.\n{result.Message}"),
        ("打开插件语音设置", "Opening voice plugin settings"),
        ("插件语音设置", "Voice plugin settings"),
        ("请查看 Harness 窗口", "Check the Harness window"),
        ("语音设置打开失败", "Voice settings failed to open"),
