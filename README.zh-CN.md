...
v1.0.0 Windows 包为自包含版本，不需要另行安装 .NET Runtime。没有驱动时，Agent Controller 仍可运行，但只会对明确 `NotSent` 的操作尝试有限回退，不能视为完整 Micro 兼容模式。
...
更完整的实现状态和边界情况，请参阅 [v1 操作清单](public/docs/controller-operations.md)、[架构与输入链路](public/docs/architecture-and-input-flow.md)、[Micro 指令表](public/docs/codex-micro-command-reference.md)与 [v1.0 版本说明](public/docs/release-v1.0.md)。
