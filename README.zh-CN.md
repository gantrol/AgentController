...
这个 [Codex Micro 桌面模拟器](virtual-micro/README.zh-CN.md) 显示可缩放的透明小键盘，是项目副产物，目前不依赖 Agent Controller。[v1.0.0 正式版](../../releases/tag/codex-micro-v1.0.0) 提供无需另外安装 .NET Runtime 的 Windows x64 便携应用。

> 未来可能会合并到AgentController
