...
- v0.7 shipped behavior / remaining validation
  ...
  - [ ] Stabilize the intermittent `BridgeFeedbackPresenterTests.DisposeUnsubscribesAndQueuedWorkCannotMutateState` queue/dispose race; four full-suite runs observed a queued row after disposal, while isolated reruns and subsequent full-suite runs through 677 tests passed
