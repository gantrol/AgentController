...
- v0.7 shipped behavior / remaining validation
  ...
  - [ ] Stabilize the intermittent `BridgeFeedbackPresenterTests.DisposeUnsubscribesAndQueuedWorkCannotMutateState` queue/dispose race; two full-suite runs observed a queued row after disposal, while isolated reruns and the following 644/653-test full runs passed
