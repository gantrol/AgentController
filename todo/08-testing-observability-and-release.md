...
- [ ] 右摇杆简易模式能以左/右调整 Power、上选择 Standard、下选择 Fast；短按 R3 打开官方模型列表并选择一个实际可用模型，选择器关闭后仍能继续控制。
- [ ] 右摇杆高级模式能以左/右切换 Model、Effort、Speed，以上/下调整当前选项；记录已知不顺畅路径，不用 transport ACK 代替界面 readback。
